...
def GabesLocEstimateMEDIAN(results): #THIS IS CURRENTLY DOING MODE, NOT MEDIAN
    import statistics
    Minresultno0 = GabesMinEesultNo0(results)
    resultsLowComDom = GabesLowestComDom(results, Minresultno0)
    ...
    for i in resultsLowComDom:
        summedResLoCoDo.append(sum(i)) 
    summedResLoCoDo.sort()
    RoundedsummedResLoCoDo = [round(num, 0) for num in summedResLoCoDo]
    RoundedsummedResLoCoDono1 = list(filter(lambda a: a != 1, RoundedsummedResLoCoDo)) 
    #print(summedResLoCoDono1)
    
    if RoundedsummedResLoCoDono1 == []:
        return 'Fixed' 
    else:    
        return (statistics.mode(RoundedsummedResLoCoDono1)/2)

def GabesLocEstimateMODE(results):
    import statistics
    Minresultno0 = GabesMinEesultNo0(results)
    resultsLowComDom = GabesLowestComDom(results, Minresultno0)
    ...
    if summedResLoCoDono1 == []:
        ...
        return (statistics.median(summedResLoCoDono1)/2)

def GabesLocEstimateMEAN(results):
    import statistics
    Minresultno0 = GabesMinEesultNo0(results)
    resultsLowComDom = GabesLowestComDom(results, Minresultno0)
    ...
    if summedResLoCoDono1 == []:
        ...
        return (statistics.mean(summedResLoCoDono1)/2)
